...
public:
    ...
    void status()
    {
        ...
        cout << "------------------------------------------------" << endl
             << endl;
        cout << "Enter the name area for deployment: " << endl;
        cout << "HongKong\nSingapore\nManila\nBangkok" << endl;
        cout << "------------------------------------------------" << endl;
        cin >> l;
...
public:
    ...
    void status()
    {
        ...
        cout << "------------------------------------------------" << endl
             << endl;
        cout << "Enter the name of area for deployment: " << endl;
        cout << "Tehran\nBeijing\nAgra\nBerlin" << endl;
        cout << "------------------------------------------------" << endl;
        cin >> l;
...
// leutinant id = 1234 // Can only view bases
// colonal id = 5678 // Can only view bases
// major id = 4321 // Can fire Missiles
// general id = 8765
